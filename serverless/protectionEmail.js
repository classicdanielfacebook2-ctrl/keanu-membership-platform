...
const protectionConfirmationHtml = ({ fullName, caseId, timestamp, reportType, supportReference }) => `
  <div style="margin:0;padding:32px;background:#050505;color:#f7f3ea;font-family:Inter,Arial,sans-serif;">
    <div style="max-width:560px;margin:0 auto;border:1px solid rgba(244,216,139,.34);background:#0d0d0d;padding:32px;">
      ...
      <p style="margin:0 0 18px;line-height:1.7;color:#cfc7ba;">Hello ${escapeHtml(fullName || "there")}, your report has been received and will be handled by the security team.</p>
      ...
      <p style="margin:0;color:#a9a197;line-height:1.7;">Eligible cases may qualify for reimbursement support following internal investigation and verification. Submitting a report does not guarantee compensation approval.</p>
    </div>
  </div>
`;
